...
import { FaFacebook, FaInstagramSquare, FaSnapchat, FaTiktok } from 'react-icons/fa';

const SocialBar = () => {
  return (
    <nav className="flex flex-row justify-around p-3 mb-3  bg-[#f7f7f7]">
      <ul className='flex flex-row list-none m-0 p-0'>
        ...
        <li className='mr-3'><a href='https://www.instagram.com/mr.cafekalar/' className='text-[#333] text-2xl'><FaInstagramSquare color='purple' size={40} /></a></li>
